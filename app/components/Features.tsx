...
import { Zap, Smartphone, Palette, Search, ShieldCheck, Settings, Code, BarChart, Globe } from "lucide-react"
...
const features = [
  ...
  {
    name: "SEO Optimized",
    description: "Built with search engines in mind to help your website rank better and reach more customers.",
    icon: Search,
  },
  {
    name: "Secure & Reliable",
    description: "Advanced security measures to keep your website and customer data safe.",
    icon: ShieldCheck,
  },
  {
    name: "Easy Management",
    description: "User-friendly admin panel to easily update your content and manage your website.",
    icon: Settings,
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            We combine cutting-edge technology with expert design to deliver websites that stand out and perform
            excellently.
          </p>
        </div>
